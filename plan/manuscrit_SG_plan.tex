...
\begin{document}
    ...
    \subsection{La notion des mesures quantiques}
    \pagebreak
    %\input{section/section_1/section_1.1/section_1_1.tex}
    
    \subsection{Les procédures des mesures directes via mesure faible}	
    \pagebreak
    %\input{section/section_1/section_1.2/section_1_2.tex}

    \subsubsection{La valeur faible}
    \pagebreak
    %\input{section/section_1/section_1.2/subsection_1_2_1.tex}
    
    %\subsubsection{Avec mesure faible}
    %\input{section/section_1/section_1.2/subsection_1_2_2.tex}
    ...
    \subsection{Proposition d'une procédure directe avec des mesures temporelles faibles}
    
    \pagebreak

    \subsection{Relation d'un délai temporel et la valeur faible de l'état de polarisation}
    \subsubsection{La partie réelle du système}
    \pagebreak
    \subsubsection{La relation d'une mesure temporelle et un décalage de fréquence}
    \pagebreak
    ...
    \subsection{Acquisition de donnée et mesure d'un délai en utilisant un oscilloscope}
    \subsubsection{Fonctionnement d'un oscilloscope}
    \pagebreak
    \subsubsection{Acquisition du délai temporel}
    \pagebreak
    ...
    \pagebreak
    \subsubsection{Résultats expérimentaux sur la partie réelle}    
    
    \pagebreak

    \subsection{Caractérisation de la partie imaginaire de la valeur faible}
    \subsubsection{**SECTION SUR LA MÉTHODE DE MESURE SUR LES DÉCALAGES DE FRÉQUENCE}
    \subsubsection{**SECTION SUR LE MONTAGE DE LA PARTIE IMAGINAIRE}
    \subsubsection{**SECTION SUR LES RÉSULTATS}
    \pagebreak
