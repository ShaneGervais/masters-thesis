...
\begin{document}
    ...
    \subsubsection{Note physique sur la réalité de l'acquisition}
    \subsection{Résultats de la partie réelle de la valeur faible}
    ...
    \subsection{Analyze des résultats expérimentaux}
    \subsubsection{La partie réelle}
    \subsubsection{Ce qu'on propose pour la partie imaginaire}
    \subsection{Discussion sur les résultats expérimentaux}
