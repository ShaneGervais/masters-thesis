...
\begin{document}
    ...
    \input{section/section_1/section_1.1/section_1_0.tex}
    ...
    \thispagestyle{empty}
    \section{LES MESURES FAIBLES TEMPORELLES ET FRÉQUENCIELLES D'UN SYSTÈME QUANTIQUE}
    \input{section/section_2/section_2.1/section_2.0.tex}
    ...
    \subsection{Mesure de la vitesse de la lumière à l'aide d'un oscilloscope}
    \input{section/section_3/section_3_1/section_3_1.tex}
    \subsubsection{Acquisition de donnée et mesure d'un délai en utilisant un oscilloscope}
