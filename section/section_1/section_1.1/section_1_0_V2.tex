...
\begin{doublespace}
    ...
    ordinateurs quantiques utilisent les propriétés naturelles de la 
    mécanique quantique pour résoudre des problèmes complexes \cite{Feynman1982,quantumcomputing40years}. 
    Contrairement aux ordinateurs classiques, un ordinateur quantique 
    utilise ce qu'on appelle des qubits (un état de bit quantifié tel 
    que $\ket{0}$ et $\ket{1}$) qui tire parti de la nature physique de la 
    mécanique quantique permettant à un état d'être dans une combinaison 
    ...
    sécuriser via une clé de distribution quantique, ce qui permet 
    également de détecter toute écoute clandestine. Des travaux sont 
...
\begin{doublespace}
    ...
    \noindent On vise à explorer les degrés de libertés 
    qui seraient compatibles avec 
    des systèmes quantiques pour identifier la manière de rendre 
    intégrable les mesures faibles. Cette flexibilité 
    rend possible l’intégration de mesures faibles dans 
    ...
    optiques existant, par exemple dans des télécommunications quantiques \cite{OpticalNetworks}. 
    ...
    interagir avec le système de manière contrôlable. 
