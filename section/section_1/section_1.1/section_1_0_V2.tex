...
\begin{onehalfspace}
    ...
    En effet, il est impossible de mesurer 
    simultanément deux variables complémentaires (ex: le moment d’arrivée 
    et la fréquence spectrale d'une particule) avec une précision absolue.
    Cette impossibilité est décrite par le 
    ...
    quantique et son effondrement lors d'une mesure. Imaginnons 
    un dé quantique initialement en superposition, une fois que 
    le dé est lancé et que le résultat est observé, le système 
    demeure dans cet état spécifique pour les mesures ultérieures
    (par exemple, l’état $\ket{5}$). Donc, pour obtenir d'autres 
    ...
    \begin{figure}[!htbp]
        ...
        \caption{Envisageons maintenant que nous lancions un dé quantique. Avant de 
        ...
        probabilité de $|c_5|^2$ de se produire. Une fois qu’il s’est 
    ...
    \noindent C'est ici que les techniques conventionnelles, comme la tomographie 
    ...
    \cite{vonNeumann} et exploite un pointeur couplé au système, 
    dont la perturbation minimale appliquée sur le système est proportionnel à une 
...
\begin{onehalfspace}
    ...
    leur potentiel, notamment en ce qui concerne: la théorie des mesures quantiques, 
    ...
    sur le décalage fréquentiel \cite{JohnCHowellFrequencyCombs,Salazar,OpticalNetworks,Steinberg_prob_div}.
