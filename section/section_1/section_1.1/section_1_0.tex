...
\begin{doublespace}
    ...
    \begin{align}
        P_{\ket{H}} &= |\bra{H}\ket{\psi}|^2 = (a\bra{H}\ket{H} + b\bra{H}\ket{V})(\bar{a}\bra{H}\ket{H} + \bar{b}\bra{H}\ket{V})\\
        &= |a|^2\\
        P_{\ket{V}} &= |\bra{V}\ket{\psi}|^2 = (a\bra{V}\ket{H} + b\bra{V}\ket{V})(\bar{a}\bra{V}\ket{H} + \bar{b}\bra{V}\ket{V})\\
        &= |b|^2
    \end{align}
    ...
    \begin{align}
        ...
        &+ \biggl(\frac{1}{\sqrt{2}}(b\bra{H}\ket{V} + b\bra{V}\ket{V})\biggr)\Biggr]\Biggl[ \biggl(\frac{1}{\sqrt{2}}(\bar{a}\bra{H}\ket{H} + \bar{a}\bra{V}\ket{H})\biggr)\\
        &+ \biggl(\frac{1}{\sqrt{2}}(\bar{b}\bra{H}\ket{V} + \bar{b}\bra{V}\ket{V})\biggr) \Biggr] = \frac{1}{2}(a + b)(\bar{a} + \bar{b})\\
        &= \frac{1}{2}(|a|^2 + a\bar{b} + \bar{a}b + |b|^2)\\
        P_{\ket{A}} &= |\bra{A}\ket{\psi}|^2 = \Biggl[\biggl(\frac{1}{\sqrt{2}}(a\bra{H}\ket{H} - a\bra{V}\ket{H})\biggr)\\ 
        &+ \biggl(\frac{1}{\sqrt{2}}(b\bra{H}\ket{V} - b\bra{V}\ket{V})\biggr)\Biggr]\Biggl[ \biggl(\frac{1}{\sqrt{2}}(\bar{a}\bra{H}\ket{H} - \bar{a}\bra{V}\ket{H})\biggr)\\
        &+ \biggl(\frac{1}{\sqrt{2}}(\bar{b}\bra{H}\ket{V} - \bar{b}\bra{V}\ket{V})\biggr) \Biggr] = \frac{1}{2}(a - b)(\bar{a} - \bar{b})\\
        &= \frac{1}{2}(|a|^2 - a\bar{b} - \bar{a}b + |b|^2)\\
        S_2 &= P_{\ket{D}} - P_{\ket{A}} = a\bar{b} + \bar{a}b = 2\mathcal{R}(a\bar{b})
    \end{align} 
    ...
    \begin{align}
        ...
        &+ \biggl(\frac{1}{\sqrt{2}}(b\bra{H}\ket{V} + ib\bra{V}\ket{V})\biggr)\Biggr]\Biggl[ \biggl(\frac{1}{\sqrt{2}}(\bar{a}\bra{H}\ket{H} + i\bar{a}\bra{V}\ket{H})\biggr)\\
        &+ \biggl(\frac{1}{\sqrt{2}}(\bar{b}\bra{H}\ket{V} + i\bar{b}\bra{V}\ket{V})\biggr) \Biggr] = \frac{1}{2}(a + ib)(\bar{a} + i\bar{b})\\
        &= \frac{1}{2}(|a|^2 + ia\bar{b} + i\bar{a}b - |b|^2)\\
        P_{\ket{L}} &= |\bra{L}\ket{\psi}|^2 = \Biggl[\biggl(\frac{1}{\sqrt{2}}(a\bra{H}\ket{H} - ia\bra{V}\ket{H})\biggr)\\ 
        &+ \biggl(\frac{1}{\sqrt{2}}(b\bra{H}\ket{V} - ib\bra{V}\ket{V})\biggr)\Biggr]\Biggl[ \biggl(\frac{1}{\sqrt{2}}(\bar{a}\bra{H}\ket{H} - i\bar{a}\bra{V}\ket{H})\biggr)\\
        &+ \biggl(\frac{1}{\sqrt{2}}(\bar{b}\bra{H}\ket{V} - i\bar{b}\bra{V}\ket{V})\biggr) \Biggr] = \frac{1}{2}(a - ib)(\bar{a} - i\bar{b})\\
        &= \frac{1}{2}(|a|^2 - ia\bar{b} - i\bar{a}b - |b|^2)\\
        S_3 &= P_{\ket{R}} - P_{\ket{L}} = i(a\bar{b} + \bar{a}b) = 2\mathcal{I}(a\bar{b})
    \end{align}
    ...
    \begin{align}
        ...
        \end{pmatrix}\\
        &= \begin{pmatrix}
            |a|^2 & \mathcal{R}(a\bar{b}) - i\mathcal{I}(a\bar{b})\\
            \mathcal{R}(\bar{a}b) - i\mathcal{I}(\bar{a}b) & |b|^2
        \end{pmatrix}\\
        &= \begin{pmatrix}
            |a|^2 & a\bar{b}\\
            \bar{a}b & |b|^2
