...
\begin{onehalfspace}
    ...
    que notre laser peut effectuer) pour une valeur attendue de $49,932$ $kHz$.
    ...
    calculer les amplitudes de probabilité (voir figure \ref{fig:prob_amp_imaginary_part_HRVLH})
    ...
    à nos attentes théoriques. Cependant, nous avons observé des
