...
\begin{onehalfspace}
    ...
    que notre laser peut effectuer) pour \textcolor{red}{une valeur} attendue de $49,932$ $kHz$.
    ...
    \begin{figure}[!htpb]
        ...
        ajustements paramétriques polynomiales du quatrième ordre pour 
    ...
    \begin{figure}[!htpb]
        \centering
        \includegraphics[width=1.0\textwidth]{imag_weak_value_path_4 copy 4.png}
    ...
    est donc non affecté par le signe du décalage observé et ne conserve que sa magnitude.
    ...
    La tendance de ces déplacements ne correspond pas directement
    à nos attentes théoriques, mais ils suivent une tendance similaire si on 
    considère la valeur absolue de l'attente théorique, c'est à dire $|sin(2\theta)|$.
    ...
    \textcolor{red}{calculer} les amplitudes de probabilité (voir figure \ref{fig:prob_amp_imaginary_part_HRVLH})
    ...
    \textcolor{red}{à} nos attentes théoriques. Cependant, nous avons observé des
    ...
    du MZ rend l’appareil sensible aux vibrations et aux 
