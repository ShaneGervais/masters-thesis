...
\begin{doublespace}
    ...
    sur une durée spectrale de $1,4062$ $GHz$ \cite{TektronixTDS5000}. L'analyse
    ...
    \begin{figure}[!htpb]
        ...
        kilohertz (kHz) par rapport à l'état $\ket{V}$.}
    ...
    calculer la partie imaginaire de la valeur faible car
    on suppose que les états de polarisation $\ket{H}$ et $\ket{V}$ 
    ne possède aucun délai fréquentiel ainsi que l'état $\ket{V}$
    est celui qui n'a pas été décalé temporellement. Nous avons
    observé que les déplacements fréquentiels sont positifs car ils
    correspondent à des augmentations de la fréquence du centroïde. 
    Ces résultats nous indiquent que nous sommes en train
    ...
    (comparer à l'état $\ket{V}$) est de $640,708$ $kHz$
    qui est largement supérieur à ce que l'on pourrait attendre
    théoriquement. 
