...
\subsubsection{Implication sur la partie imaginaire}

\begin{doublespace}
    Considérons le terme proportionnel dans la partie imaginaire de la valeur faible:
\end{doublespace}
