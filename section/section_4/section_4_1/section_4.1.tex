\begin{onehalfspace}
    ...
    états de polarisation d'entrée en utilisant le même ajustement
    paramétrique que celui effectué dans les expériences de la vitesse
    de la lumière/signal électrique au chapitre précédent.
    Cependant, pour obtenir de bonnes mesures de délais, il faut d'abord calibrer l'expérience. Pour ce faire, 
    ...
    d'arrivé du signal en introduisant un délai maximal. 
    ...
    de chaque mesure de calibration à partir
