...
\begin{doublespace}
    ...
    \noindent Nous abservons une visibilité similaire à celle du trajet de polarisation linéaire
    $\mathcal{V} \approx 0.11$ pour le trajet de polarisation en superposition. 
    Ceci se voit dans la figure \ref{fig:DRAL_delay_results} et correspond aux 
    incertitudes expérimentales observées. 
