...
\begin{doublespace}
    ...
    \begin{figure}[!htpb]
        \centering
        \includegraphics[width=1.0\textwidth]{real_part_visibility.png}
    ...
    qui pose une difficulté à mesurer.

    \noindent Avec la source utilisée, nous ne pouvons pas 
    observer les effets de ce terme d'interférence et obtenir des délais 
    négatifs pour la partie réelle de la valeur faible. Ceci est 
    dû à la faible longueur de cohérence de notre source laser.
    Or, nous sommes en mesure de caractériser les états de
    polarisation d'entrée avec succès relative pour la partie réelle de
    la valeur faible. Il y a cependant
