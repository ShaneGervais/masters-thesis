...
\begin{onehalfspace}
    ...
    d'entrée. Nous attribuons ce décalage au terme additionnel
    ...
    longueur de cohérence car la largeur des pics dans la visibilité est très courte ainsi
    ...
    \noindent Ainsi, ce 
    terme \sout{génère du bruit et} provoque le décalage observé entre les équations
    ...
    est de $\mathcal{V} = 0.11$, correspondant bien à l'interaction faible de $167$ $ps$ 
    ...
    déplacer la partie réelle de la valeur faible. 
    ...
    aussi déterminer l'effet du terme d'interférence en fonction de la visibilité 
    avec l'équation:
