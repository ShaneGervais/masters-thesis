...
\begin{doublespace}
    ...
    aussi d'écrire l'effet du terme d'interférence en fonction de la visibilité 
    avec l'équation:
    ...
    \noindent Nous démontrons des différentes valeurs de visibilité et comment le terme d'interférence
