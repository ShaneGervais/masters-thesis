...
\begin{doublespace}
    ...
    \begin{figure}[!htpb]
        \centering
        \includegraphics[width=1.0\textwidth]{real_part_vis_5_analysis.png}
        \caption{Trajet de polarisation $\ket{R} \to \ket{A} \to \ket{L} \to \ket{D} \to \ket{H}$
        avec ajustement paramétrique pour le terme d'interférence.}
        \label{fig:vis_real_path_3}
    \end{figure}

    \noindent Nous avons observé une visibilité de
    $\mathcal{V} \approx 0.33$ pour le trajet de polarisation en superposition. 
