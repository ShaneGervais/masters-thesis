...
\begin{doublespace}
    ...
    mesurons les délais de chaque état $\ket{\psi(\theta)}$. En effet, la courbe 
...
\begin{doublespace}
    ...
    \noindent En outre, à partir de ces données pour chaque trajet, nous 
    pouvons directement calculer les modules d'amplitudes de probabilité de l’état 
...
\begin{doublespace}
    ...
    $\frac{\tau}{2}$, ce qui est conforme à nos attentes expérimentales.
\end{doublespace}