...
\begin{figure}[!h!t!p!b]
    ...
    La courbe théorique est la partie réelle de la valeur faible
    calculée dans la section 2.3 (un cosinus carré). Les données sont normalisées par le
...
\begin{figure}[!h!t!p!b]
    ...
    de l'équation \ref{eq:expval_t_1}, \ref{eq:amplitude_a} et \ref{eq:amplitude_b}.}
...
\begin{doublespace}
    ...
    partie réelle de la valeur faible.
    Les résultats sont conformes à nos attentes théoriques,
...
\begin{doublespace}
    ...
    car les amplitudes de probabilité sont bien représentées par ceux 
    des équations \ref{eq:amplitude_a} et \ref{eq:amplitude_b} et suit 
    la même tendance que le trajet précédent.
    Nous avons ensuite mesuré les amplitudes de probabilité pour le trajet 
