\begin{doublespace}
    ...
    les deux composantes polarisées du système. Ce décalage modifie la 
    ...
    dans le spectre d’interférence sous la forme d’un déplacement de la 
    position des peignes de fréquences du spectre, causé par 
    l’interaction faible. Comme le temps et la fréquence sont des 
    ...
    faible et l’autre servant de référence. Cette interférence génère 
    une fréquence de battement, dont le spectre de puissance est modulé 
    par l’interaction faible. L’information sur l’état de polarisation 
    se retrouve dans la valeur faible.
    ...
    vertical (l’état $\ket{V}$) dans la partie mesure faible du 
    dispositif, correspondant à l’absence de délai (interaction). Le 
