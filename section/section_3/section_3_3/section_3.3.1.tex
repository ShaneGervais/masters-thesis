...
\begin{onehalfspace}
    ...
    Mach-Zehnder (MZ) ce qui permet d’extraire le décalage 
    ...
    \begin{figure}[!htpb]
        ...
        Mach-Zehnder. Un séparateur de faisceau non polarisant 
    ...
    l’interaction faible. Le spectre de visibilité obtenu lors de l’alignement en modifiant
    ...
    \noindent Pour contourner ce problème, nous
    ...
    nous pouvons \textcolor{red}{faire} interférer constructivement ou destructivement
    le signal expérimental \textcolor{red}{avec} le signal d'interférence pour identifier
    quels pics sont causés par des interférences (voir la figure \ref{fig:imagexp}).
    ...
    La visibilité obtenue est d'environ $0,7877$ lorsque les 
