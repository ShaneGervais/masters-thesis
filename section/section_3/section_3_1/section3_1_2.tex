...
\begin{doublespace}
    ...
    le temps d'arrivée du signal représenté par le pic maximal 
    de la dérivée. Ensuite, nous ajusterons une courbe à ce pic pour
    ...
    Pour chaque longueur de câble (ainsi que pour les différents parcourts
    de la mirroir pour l'expérience de la vitesse de la lumière), 
    ...
    résolution de $1/10000$ de la résolution de l’oscilloscope 
    et négligeons environ $40 \%$ des données 
    d’amplitude initiales; l’ajustement était donc susceptible d’être 
    ...
    l'expérience réalisée avec le cable le plus court.
...
\begin{longtable}{p{2.0cm} p{2.0cm} p{4.0cm} p{2.0cm}}
    ...
    Type de fit & Longueur du câble (mm) & Temps d'arrivée (ns) & Écart-type (ns) \\
    \midrule
    \endfirsthead
...
\begin{doublespace}
    ...
    \noindent Il montre également 
    l'écart-type de la façon dont la position du temps d'arrivée change 
    pour chaque fichier individuel pour la même longueur de câble. 
    La figure \ref{fig:BNC-pulse} montre le profil temporel 
    ...
    \noindent Il inclut les différents ajustements, vitesse mesurée
    ...
    \begin{figure}[h]
        ...
        \caption{
        Résultats des délais mesurés pendant l'expérience sur la 
        vitesse d'un signal électrique dans un câble BNC, ainsi que leur 
        ajustement linéaire. Les 
        ...
        $\pm 2$ $ps$. Ils sont tros petits pour être visibles sur
        la figure. 
        }
        \label{fig:BNC-res}
    \end{figure}
    ...
    $198 117 476$ $m/s$, ce qui représente une erreur en 
