...
\begin{doublespace}
    ...
    \begin{figure}[!hptb]
        \centering
        \includegraphics[width=1.0\textwidth]{speed_BNC copy 3.png}
        \caption{
        ...
        linéaire des données. La valeur de l'ajustement linéaire est
        en $ns/mm$ pour la pente.
    ...
    $0,00506615$ $ns/mm$ et un coefficient de corrélation 
    $R^2$ de $0,9999$,
