...
\begin{doublespace}
    ...
    \begin{figure}[!hptb]
        \centering
        \includegraphics[width=1.0\textwidth]{speed_BNC copy 2.png}
        \caption{
        ...
        linéaire des données. Les valeurs de l'ajustement linéaire sont
        en $ns/mm$ pour la pente et en $ns$ pour l'ordonnée à l'origine.
    ...
    $0,00504738$ $ns/mm$ et une ordonnée à l'origine de
    $0,0947$ $ns$. Le coefficient de corrélation $R^2$ est de $0,9999$,
