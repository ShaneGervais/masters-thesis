\begin{doublespace}
    ...
    \begin{figure}[!hptb]
    \centering
    \includegraphics[width=1.0\textwidth]{speed_light copy.png}
    ...
    $0,03345063$ $ns/cm$ et une ordonnée à l'origine de
    $0,0393$ $ns$. Le coefficient de corrélation $R^2$ est de $0,9994$,
