\begin{onehalfspace}
    ...
    peut être \textcolor{red}{utilisé} pour mesurer la vitesse de la lumière en
    utilisant un miroir ajustable pour
    créer un délai temporel. Cela se fait en
    ...
    système. Nous allons maintenant présenter les résultats de cette expérience.
    ...
    parcourues par les impulsions, ainsi que les écarts-types. \textcolor{red}{FIXED}


    \begin{longtable}{p{2.0cm} p{2.0cm} p{4.0cm} p{2.0cm} }
        \caption{Résultats des temps d’arrivée mesurés selon différentes distances 
        de parcours des impulsions et types d’ajustement avec leurs 
        écarts-types pour l'expérience de la vitesse de la lumière} \\
        \toprule
        ...
        % Paste all your rows here like:
                poly2     & 0            & 4.71330          & 0.00540 \\
        poly2     & 5.08         & 4.89050          & 0.00260 \\
        poly2     & 10.16        & 5.06520          & 0.00270 \\
        poly2     & 20.32        & 5.39390          & 0.00350 \\
        poly2     & 40.64        & 6.07950          & 0.00302 \\
        poly2     & 60.96        & 6.76310          & 0.00531 \\
        poly2     & 81.28        & 7.44000          & 0.00568 \\
        poly2     & 101.60       & 8.11440          & 0.00226 \\
        poly2     & 121.92       & 8.79660          & 0.00352 \\
        \midrule
        ...
        fourier1  & 101.60       & 8.11617          & 0.00191 \\
        ...
        fourier2  & 101.60       & 7.93620          & 0.25209 \\
        ...
        fourier3  & 101.60       & 8.12069          & 0.01187 \\
        ...
        fourier4  & 101.60       & 8.01239          & 0.20774 \\
        ...
        fourier5  & 101.60       & 7.96551          & 0.26103 \\
        ...
        fourier6  & 101.60       & 8.01208          & 0.20554 \\
    ...
    à celle de l'expérience précédente. Les écarts-types sont également 
    faibles, ce qui
    suggère que les mesures sont précises et répétables.
    La figure \ref{fig:fits_light}
    présente les ajustements de courbe \textit{poly4} pour les données d'impulsion
    ...
    à la vitesse théorique de la lumière dans l'air
    (l'indice de refraction dans l'air: $n_{air} \approx 1.00129382$
    \cite{RefractiveIndexAir}),
    \textcolor{red}{qui est de $\sim 0.9998\,c$ \cite{SpeedOfLight,hecht2012optics}}. \textcolor{red}{FIXED}
    ...
    \begin{longtable}{p{2.0cm} p{4.0cm} p{2.0cm}}
        ...
        % Paste all your rows here like:
        poly2     & 298332866     & 0.46696 \\
        poly3     & 298627177     & 0.36877 \\
        poly4     & 298995966     & 0.24573 \\
        poly5     & 299645898     & 0.02889 \\
        poly6     & 299281573     & 0.15044 \\
        poly7     & 299644656     & 0.02931 \\
        poly8     & 316855417     & 5.71273 \\
        poly9     & 343748684     & 14.68516 \\
        fourier1  & 298400345     & 0.44445 \\
        fourier2  & 301184431     & 0.48441 \\
        fourier3  & 293000217     & 2.24610 \\
        fourier4  & 299256846     & 0.15869 \\
        fourier5  & 308064592     & 2.77984 \\
        fourier6  & 297571744     & 0.72089 \\
        gauss1    & 298340041     & 0.46457
 
    \end{longtable}

    \noindent Les temps d’arrivée mesurés sont comparés à celui obtenu 
    lorsque le miroir est fixe, permettant ainsi de déterminer les délais associés à 
    chaque position. Ces délais sont ensuite utilisés pour calculer la vitesse de la 
    lumière à l’aide d’une régression linéaire. La figure \ref{fig:speed-res} 
    présente les résultats de notre expérience.

    \begin{figure}[!hptb]
    \centering
    \includegraphics[width=1.0\textwidth]{speed_light copy 3.png}
    \caption{Détermination de la vitesse de la lumière à partir des
    délais mesurés $\tau$ pour différentes parcours $\Delta x$ des impulsions
    avec un miroir ajustable. Les valeurs de l'ajustement linéaire sont
    en $ns/cm$ pour la pente et en $ns$ pour l'ordonnée à l'origine. La ligne représente l'ajustement linéaire
    des données. Les barres d’erreur horizontales représentent l’incertitude de nos
    ...
    (voir figure \ref{fig:BNC-res}). Ils sont trop petits pour être visibles sur
    la figure.
    }
    \label{fig:speed-res}
    \end{figure}

    \noindent L'ajustement linéaire des données nous donne une pente de
    $0,03344527$ $ns/cm$ qui correspond à $\frac{1}{c}$ (à rafiner en fonction de la formule) et un coefficient de corrélation $R^2$ de $0,9994$,
    ce qui indique que les données sont bien ajustées par une droite.
    En utilisant les résultats de cette expérience, nous avons
    pu mesuré la vitesse de la lumière, avec une valeur de $298 995 966 \pm 0,7881$ $m/s$,
    \textcolor{red}{ce qui correspond à un écart-type de $\sim 0.246\,\%$ par rapport à la
    ...
    $198 117 476 \pm 0,0008$ $m/s$, correspondant à un erreur pourcentage de $\sim 0,237\,\%$,
    nous permet de confirmer que nous sommes capables de mesurer
    des délais très courts dans l'ordre des picosecondes, avec un écart-type
    de $3.4$ $ps$ (voir le fit polynôme 4 du tableau \ref{table:fits_light}).
