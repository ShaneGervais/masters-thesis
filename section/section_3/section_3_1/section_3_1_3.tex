\begin{onehalfspace}
    ...
    peut être utilisé pour mesurer la vitesse de la lumière en
    ...
    parcourues par les impulsions, ainsi que les écarts-types. 
    ...
    qui est de $\sim 0.9998\,c$ \cite{SpeedOfLight,hecht2012optics}. 
    ...
    ce qui correspond à un écart-type de $\sim 0.246\,\%$ par rapport à la
    valeur théorique de la vitesse de la lumière dans l'air. Également
