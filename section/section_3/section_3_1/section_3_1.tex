...
\begin{onehalfspace}
    ...
    signal électrique qui se déplace dans \textcolor{red}{des câbles BNC} de différentes
    ...
    tandis que la voie transmise est dirigée vers un miroir qu'on déplace
    ...
    utilisons simplement différentes longueurs de câble \textcolor{red}{branchés à} 
    notre photodétecteur, désignées par $\Delta L$. Pour l'expérience de la 
...
\end{figure}
    ...
    \noindent Notre laser est une source diode
    émettant des impulsions avec une durée réglable de $5$ à $39$ $ns$ \cite{ThorlabsNPL64B}.
    Nous utilisons une impulsion de $10$ $ns$
    pour nos expériences, car les intervalles de temps plus longs  
    rendent la mesure moins précise. \textcolor{red}{\sout{Cette perte de précision se présente 
    ...
    rend l'analyse moins facile.}} \textcolor{red}{Quand nous allongeons la durée de l'impulsion,
    la distribution temporelle du signal devient similaire à celle d'une 
    fonction porte \cite{ThorlabsNPL64B}, ce qui rend à trouver le 
    temps moyen plus difficile.}
    Donc, nous avons opté à identifier le 
    temps d'arrivée de l'impulsion comme la variable temporelle moyenne
    du pointeur pour faciliter l'analyse.
