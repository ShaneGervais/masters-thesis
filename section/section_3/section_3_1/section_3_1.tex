...
\begin{onehalfspace}
    ...
    signal électrique qui se déplace dans des câbles BNC de différentes
    ...
    utilisons simplement différentes longueurs de câble branchées à 
...
\end{figure}
    ...
    rendent la mesure moins précise. Quand nous allongeons la durée de l'impulsion,
