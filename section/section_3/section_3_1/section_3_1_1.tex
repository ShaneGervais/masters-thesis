\begin{onehalfspace}
    ...
    référence et un signal expérimental. Nous obtenons le signal expérimental
    ...
    Le signal de référence déclenche l'oscilloscope sur son front montant et 
    ...
    ce qui réduit le bruit de fond d'un facteur $\sqrt{1000} \approx 32$.
    ...
    \begin{figure}[!hptb]
        ...
        répétitif en cours d’acquisition pour reconstruire le signal complet. 
    ...
    câble BNC RG-58 $50 \Omega$ \cite{ThorlabsBNC} avec des délais temporels implémentés
    ...
    Les délais 
    commencent par une mesure avec le câble le plus court; dans ce cas, le miroir ajustable est fixe. Pour 
