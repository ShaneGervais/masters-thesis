\begin{doublespace}
    ...
    notre référence, qui correspond à la longueur initiale du câble
    ...
    l’interpolation et le temps d'équivalent. En mode 
    ...
    \begin{figure}[!hptb]
        ...
        L’oscilloscope en mode de temps d'équivalent
    ...
    un délai en déplaçant le miroir à différentes distances: 
    $2,52~$, $5,48~$, $10,10~$, $20,19~$, $30,29~$, $40,38~$, $50,48$ 
    et $65,62$ $cm$ (converti à partir des pouces, car 
    notre platine de translation linéaire manuelle est en unités 
    impériales). Le délai mesuré 
