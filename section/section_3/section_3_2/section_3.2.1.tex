...
\begin{onehalfspace}
    \noindent Donc, les états d'entrée selon l'angle $\theta$ préparés sont:
\end{onehalfspace}
...
\begin{onehalfspace}
    ...
    l'angle de la lame demi-onde de $2,5$
    ...
    $\ket{H}$. L’opération de la lame quart d'onde se définit par 
    la matrice suivante:
\end{onehalfspace}
