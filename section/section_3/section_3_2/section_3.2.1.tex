...
\begin{doublespace}
    ...
    L'opérateur $\hat{T}_{HWP}(\theta)$ est un opérateur unitaire 
    ...
    demi-onde. Cependant, nous l'apellons un opérateur unitaire 
    car il agit sur l'état d'entrée $\ket{\psi}$ de manière unitaire,
    ...
    après la transformation. Ce caractère unitaire est essentiel
