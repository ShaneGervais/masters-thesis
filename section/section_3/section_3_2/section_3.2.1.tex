...
\begin{doublespace}
    ...
    quart de lame d’onde pour inverser l’état de base pour que le bras 
    réfléchi soit transmis et que celui transmis soit réfléchi, afin 
    ...
    et en revenant. Il produira un état de polarisation $\ket{V}$ qui 
    ...
    Comme rappel nous avons calculé dans le chapitre 2, la 
