\begin{doublespace}
    Notre dispositif expérimental, représenté à la figure \ref{fig:realexp}, est composé de notre laser pulsé de tout à l’heure et suit une configuration similaire à celle de notre montage précédent (figure \ref{fig:speed-of-light}). Cependant, après le premier séparateur de faisceau, l’état de polarisation d’entrée est préparé et ensuite soumis une mesure faible en introduisant un court délai avec une différence de parcours entre les deux composantes orthogonales venant du deuxième séparateur de faisceau. Finalement, une mesure projective est effectuée pour une caractérisation complète et directe.
\end{doublespace}
...
\begin{doublespace}
    ...
    \noindent Comme rappel nous avons calculé dans le chapitre 2, la partie réelle de la valeur faible est donnée par le suivant:
