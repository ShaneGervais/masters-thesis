\begin{doublespace}
    ...
    l'équation \ref{eq:t_norm_interférence}, ce que nous allons donc calculer
    $\hat{t}$ qui est lié à la partie réelle de la valeur faible
    $\mathcal{R}\Bigl(\expval{\hat{\pi}_W}\Bigr) \equiv \frac{\expval{\hat{t}}}{\tau}$
