\begin{doublespace}
    ...
    Nous allons conclure cette thèse avec des mots finaux sur
    ...
    grandeurs physiques avec une précision sans précédent \cite{metrology,QuantumLimitedMetrology, RydbergDispersion}, ouvrant la
    ...
    nous permettrait de faciliter la mesure de la partie imaginaire de
