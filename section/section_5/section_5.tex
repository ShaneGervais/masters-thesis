\begin{onehalfspace}
    ...
    des défis subsistent, notamment la stabilité du laser \textcolor{red}{qui n'est pas encore optimale}
    ...
    d'interférence est \textcolor{red}{censé} produire des délais négatifs, mais cela
    ...
    et vérifié que ce modèle s’applique aux impulsions lumineuses en \textcolor{red}{déterminant la 
    vitesse de la lumière à partir de ces délais}, (ii) réalisé un dispositif
