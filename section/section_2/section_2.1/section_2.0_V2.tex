...
\begin{doublespace}
    ...
    procédure de mesure faible, nous projetterons une postsélection 
...
\begin{doublespace}
    ...
    en extraire des informations, nous réalisons une postsélection à 
...
\begin{doublespace}
    ...
    \begin{align}
        ...
        |b| &= \sqrt{|a|^2 - 1}\label{eq:amplitude_b}
    \end{align}
