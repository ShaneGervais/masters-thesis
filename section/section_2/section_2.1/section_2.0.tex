...
\begin{doublespace}
   ...
   \noindent Comme nous sommes dans le régime des mesures faibles, prenons la limite où $\tau \ll \sigma$:
    ...
    \noindent Ce terme correspond à la partie réelle de la valeur faible attendue $\expval{\hat{\pi}_W}$.
\end{doublespace}
