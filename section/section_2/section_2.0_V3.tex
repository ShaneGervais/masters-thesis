...
\subsection{Les mesures quantiques: une procédure reconstructive à caractériser un état quantique}
...
\subsubsection{La tomographie quantique}
...
\begin{onehalfspace}
    ...
    \cite{TomoReview}.
    Étant donné que les photons ont un grand nombre de 
    paramètres à caractériser, telles que leurs différents états 
...
\subsubsection{Introduction aux mesures faibles}
...
\begin{onehalfspace}
    ...
    \noindent Considérons les scénarios à la figure \ref{fig:interaction} 
    dans lequel le système à caractériser
    est l'état de polarisation d'un photon, et le pointeur est une autre
    propriété du photon, comme sa position temporelle décrite par 
    une distribution gaussienne avec une largeur $\sigma$. 
    Initialement, avant la mesure faible, le système et le pointeur sont couplés avec une force
    ...
    \noindent En effectuant une mesure projective après une interaction
    faible, nous obtenons une distribution de probabilité du pointeur similaire
...
\subsubsection{Fondamentaux théoriques des mesures faibles}
...
\begin{onehalfspace}
    ...
    \noindent où $g$ est la constante de couplage, qui doit être réelle 
...
\begin{onehalfspace}
    ...
    \noindent où $N$ est une constante indépendante de 
    ...
    \noindent En effectuant une mesure faible
