...
\begin{document}
    ...
    \begin{longtable}{@{}lll@{}}
      ...
      $\ket{D}$ & Polarisation diagonale $\frac{1}{\sqrt{2}} \begin{pmatrix} 1 \\ 0 \end{pmatrix}$ & 2 \\
      $\ket{A}$ & Polarisation anti-diagonale $\frac{1}{\sqrt{2}} \begin{pmatrix} 0 \\ -1 \end{pmatrix}$ & 2 \\
      ...
      $\mathcal{H}$ & Hamiltonien du système & 2 \\
      ...
      $\hat{T}$ & Opérateur d’une plaque d’onde & 3 \\
      $\theta$ & Orientation d’une composante & 3 \\
      $\phi$ & Orientation d’une composante & 3 \\
    \end{longtable}
    ...
    \thispagestyle{empty}
    \section{INTRODUCTION DES PROCÉDURES DIRECTES POUR LES MESURES QUANTIQUES}
    %\subsection{Les notions de la mécanique quantique}
    %\input{section/section_1/section_0_1/section_0_1.tex}
    %\subsubsection{Notation}
    %\input{section/section_1/section_0_1/section_0_1_1.tex}
    %\subsubsection{Description d'un état quantique, opérateur et observable}
    %\input{section/section_1/section_0_1/section_0_1_2.tex}
    %\subsubsection{Observable et opérateur}
    %\input{section/section_1/section_0_1/section_0_1_3.tex}
    %\subsubsection{Mesure quantique}
    %\input{section/section_1/section_0_1/section_0_1_4.tex}
    %\subsection{Compréhension analogique des mesures quantiques}
    \input{section/section_1/section_1.1/section_1_0_V2.tex}
    
    %\subsection{La procédure des mesures directes via mesure faible}	
    %\input{section/section_1/section_1.1/section_1_1.tex}
    %\input{section/section_1/section_1.1/section_1_1_24012025.tex}
    
    %\input{section/section_1/section_1.2/section_1_2.tex}

    %\subsubsection{Mesure direct de la fonction d'onde d'un état quantique}
    %\input{section/section_1/section_1.2/section_1_2_1.tex}
    
    %\subsubsection{Lecture simultanée des parties réelle et imaginaire de la valeur faible}
    %\input{section/section_1/section_1.2/section_1_2_2.tex}


    %\subsection{Motivation de la thèse}
    %\input{section/section_1/section_1.3/section_1_3.tex}
    \pagebreak
    
    \thispagestyle{empty}
    \section{LES MESURES FAIBLES TEMPORELLES D'UN SYSTÈME QUANTIQUE}
    \input{section/section_2/section_2.1/section_2.0_V2.tex}
    %\subsection{Proposition d'une procédure directe avec une mesure faible temporelle}
    %\input{section/section_2/section_2.1/section_2_1.tex}
    %\subsection{Mesure faible temporelle d'un système photonique quantique}
    %\input{section/section_2/section_2.2/section_2_2.tex}
    %\subsubsection{La partie réelle du système}
    %\input{section/section_2/section_2.2/section_2_2_1.tex}
    %\subsubsection{La partie imaginaire du système}
    %\input{section/section_2/section_2.2/section_2_2_2.tex}
    %\subsection{Proposition expérimentale pour la caractérisation de la valeur faible}
    %\input{section/section_2/section_2.3/section_2_3.tex}
    %\subsection{Conclusion sur la théorie}
    %\input{section/section_2/section_2.4/section_2.4.tex}
    \pagebreak

    \thispagestyle{empty}
    \section{MESURE EXPÉRIMENTALE DIRECTE D'UN ÉTAT DE POLARISATION EN UTILISANT UNE MESURE FAIBLE TEMPORELLE}
    \input{section/section_3/section_3_1/section_3_intro.tex}
    \subsection{Mesure de délai temporel ultra courte}
    \input{section/section_3/section_3_1/section_3_1.tex}
    \subsubsection{L’importance de l’acquisition de données	}
    \input{section/section_3/section_3_1/section_3_1_1.tex}
    \subsubsection{Analyse et résultats de l'expérience de la vitesse de la lumière}
    \input{section/section_3/section_3_1/section3_1_2.tex}
    \subsection{Caractérisation de la partie réelle de la valeur faible}
    \input{section/section_3/section_3_2/section_3.2.tex}
    \subsubsection{Montage préposé et étape de préparation}
    \input{section/section_3/section_3_2/section_3.2.1.tex}
    \subsection{Caractérisation de la partie imaginaire de la valeur faible}
    \input{section/section_3/section_3_3/section_3.3_intro.tex}
    \subsubsection{Montage préposé}
    \input{section/section_3/section_3_3/section_3.3.1.tex}
    
    \pagebreak

    \thispagestyle{empty}
    \section{RÉSULTATS ET DISCUSSION}    
    \input{section/section_4/section_4_1/section_4.tex}
    ...
    \input{section/section_4/section_4_1/section_4.1.tex}
    \subsubsection{La partie réelle}
    \input{section/section_4/section_4_1/section_4_1_1.tex}
    \subsubsection{Discussion sur les résultats expérimentaux de la partie réelle}
    \input{section/section_4/section_4_1/section_4_1_2.tex}
    \subsection{La partie imaginaire}
    \input{section/section_4/section_4_2/section_4.2.tex}

    \pagebreak

    \thispagestyle{empty}
    \section{CONCLUSION}
    \input{section/section_5/section_5.tex}
    \pagebreak
    ...
    \appendix
    \section*{ANNEXE A: Tableaux de l'expérience de la vitesse de la lumière}
    \addcontentsline{toc}{section}{\protect\numberline{} ANNEXE A}
    \input{annexe/annexe_A.tex}

    \pagebreak
    \thispagestyle{empty}
    \section*{ANNEXE B: Validation de la précision fréquenciel par l'effet Doppler}
    \addcontentsline{toc}{section}{\protect\numberline{} ANNEXE B}
    \input{annexe/annexe_B.tex}
