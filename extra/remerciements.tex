\begin{onehalfspace}
    ...
    \noindent Mes grands-pères (Gervais, Hamilton et Edward), pour leur sagesse, leur gentillesse et leur amour inconditionnel m'ont toujours inspiré ma créativité et ma passion dans la vie.
    ...
    \noindent Mon ami Logan, pour m'avoir toujours fait rire et pour m'aider à voir le côté positif des choses.

    \noindent \textit{Je vous aime tous.} 

    \noindent Et toutes les autres personnes que j'ai rencontrées pendant ma maîtrise et qui m'ont apporté de la joie, de l'amitié et du courage : Koceila, Mathéo, Elisa, Marie-Céline, Paul-Henry, Mathias, Shiva, Chris et d'autres.
