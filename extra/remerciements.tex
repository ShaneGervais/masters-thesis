\begin{onehalfspace}
    ...
    \noindent Ma mamie, pour m'avoir toujours encouragé à poursuivre mes rêves et à croire en moi-même. Ainsi que pour m'avoir nourri avec ses délicieux plats faits maison chaque fois que je lui rendais visite. 

    \noindent Mes grands-pères (Gervais, Hamilton et Edward), pour leur sagesse, leur gentillesse et leur amour inconditionnel m'ont toujours inspiré à être une meilleure personne.
    ...
    \noindent Ma petite amie, pour avoir toujours été là pour moi. Quand les choses allaient mal, elle était toujours là pour me guider vers un meilleur chemin. Quand je doutais de moi-même, elle me donnait la confiance, la foi et l'assurance dont j'avais besoin pour continuer. Elle a toujours cru en moi depuis le début et je lui en suis très reconnaissant. Je t'aime.

    \noindent Mon ami Shawn, pour toujours avoir été là pour moi depuis le début. Il a cru en moi quand je ne croyais pas en moi-même et m'a toujours encouragé à devinir le meilleur que je puisse être. De nos nombreuse de discussions sur la physique quantique à nos sessions d'athlétique, il a toujours su me remonter le moral et me motiver à continuer.
    ...
    \noindent Mon ami Alexandre, pour m'avoir toujours encouragé à jamais finir le matche. 

    \noindent Mon ami Logan, pour m'avoir toujours fait rire même dans les moments les plus difficiles et pour m'aider à voir le côté positif des choses.

    \noindent \textit{Je vous aime tous.} 

    \noindent Et toutes les autres personnes que j'ai rencontrées pendant mon master et qui m'ont apporté de la joie, de l'amitié et du courage : Koceila, Mathéo, Elisa, Marie-Céline, Paul-Henry, Mathias, Shiva, Chris et d'autres.
