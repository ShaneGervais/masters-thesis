\begin{doublespace}
    ...
    \noindent Nous proposons de réaliser des mesures faibles temporels en exploitant 
    ...
    quantique facile à implanter dans un laboratoire d'optique commun. Cela permettrait une intégration 
