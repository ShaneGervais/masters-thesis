\begin{onehalfspace}
    On souhaite estimer notre capacité à mesurer des \textcolor{red}{décalages} courts de 
    fréquence donc nous implémentons une expérience de mesure d'effet 
    doppler. Pour l’illustrer, considérons le son d’une sirène:
    à l’approche, le bruit semble plus aigu, alors \textcolor{red}{qu'à l'éloignement}, 
    le bruit semble grave. Cet effet est 
    causé par l’effet Doppler, qui fait varier 
    la fréquence selon la vitesse de la source 
    en relation avec l'observateur ou récepteur. 
    ...
    traverse un espace-temps courbé ou \textcolor{red}{quand une galaxie s'éloigne}.  
...
\begin{onehalfspace}
    ...
    fréquentiels de $3$ $kHz$ pour une impulsion de 
...
\begin{onehalfspace}
    ...
    $0,585$ $cm$. Calculons théoriquement 
    la valeur de la fréquence initiale de $467.33$ $THz$ sera 
    décalée. 
\end{onehalfspace}
